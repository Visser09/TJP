...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900/30 backdrop-blur-xl border-b border-white/10 px-4 sm:px-6 lg:px-8 py-4 sticky top-0 z-30 w-full">
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center space-x-2 sm:space-x-4">
          <h1 className="text-lg sm:text-2xl font-bold" data-testid="text-page-title">Trading Dashboard</h1>
          <div className="hidden sm:block text-sm text-gray-400" data-testid="text-current-date">
            {formatDate()}
          </div>
        </div>
